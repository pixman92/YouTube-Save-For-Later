...
function run() {
    ...
    saveLyricData('come back to me', 'great jam!', '0');
    saveLyricData('breaking the Habit', 'ugh, love it!', '0');
...
// ==================================
var arrayMe = ["largeWidthLyrics", "dynamicURLPage"];
function hide() {
...
function show(classIt) {
    document.querySelector("." + classIt).show();
}
